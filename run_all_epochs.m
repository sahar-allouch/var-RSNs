...
% compute headmodels and leadfields once for all.
% You may comment the following line if you have already run them.
% Headmodel and leadfields are saved in'inputs/'
get_headmodel_and_leadfields()
